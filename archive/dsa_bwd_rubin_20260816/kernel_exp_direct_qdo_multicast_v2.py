...
class FlashAttentionDSABackwardSm100TwoCTA(FlashAttentionDSABackwardSm100):
    ...
    def __call__(
        ...
        direct_mcast_op = cpasync.CopyBulkTensorTileG2SMulticastOp(
            tcgen05.CtaGroup.ONE
        )
        tma_atom_qt_direct, _ = cute.nvgpu.make_tiled_tma_atom_A(
            direct_mcast_op,
            mQT,
            grad_a_layout,
            self.DKV_MMA_TILER,
        ...
        tma_atom_dot_direct, _ = cute.nvgpu.make_tiled_tma_atom_A(
            direct_mcast_op,
            mdOT,
            grad_a_layout,
            self.DKV_MMA_TILER,
    ...
    def kernel(
        ...
        tma_atom_qt_direct: cute.CopyAtom,
        tma_atom_dot_direct: cute.CopyAtom,
        mQ: cute.Tensor,
        mKV: cute.Tensor,
        mdO: cute.Tensor,
        mdQ: cute.Tensor,
        ...
        if warp_idx == 0:
            ...
            cpasync.prefetch_descriptor(tma_atom_qt_direct)
            cpasync.prefetch_descriptor(tma_atom_dot_direct)
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    def _specialize_shared_storage(
        ...
        class SharedStorageV2:
            ...
            # One-shot W19 peer handshake: both CTAs arm their local
            # multicast completion barriers before rank 0 can issue.
            direct_mcast_ready_mbar: cutlass.Int64
    ...
    def kernel(
        ...
        direct_mcast_ready_mbar = storage.direct_mcast_ready_mbar.ptr
        ...
        t_qt_direct_smem_a, t_qt_direct_gmem = cpasync.tma_partition(
            tma_atom_qt_direct,
            block_coord_vmnk[2],
            a_cta_layout,
        ...
        t_dot_direct_smem_a, t_dot_direct_gmem = cpasync.tma_partition(
            tma_atom_dot_direct,
            block_coord_vmnk[2],
            a_cta_layout,
        ...
        if tidx == Int32(0):
            ...
            cute.arch.mbarrier_init(direct_mcast_ready_mbar, 1)
            cute.arch.mbarrier_init(
                kdq_ready_mbar,
                self.GATHER_THREADS,
            )
    ...
    def _transition_alias_pages_vb(
        ...
        direct_mcast_ready_mbar: cute.Pointer,
        q_phase: Int32,
        do_phase: Int32,
        q_pipeline,
        do_pipeline,
        ...
        # W19-only peer rendezvous.  The remote arrival is ordered after
        # this CTA's two expect_tx operations; waiting on our local phase
        # proves the peer has armed its completion barriers as well.
        with cute.arch.elect_one():
            cute.arch.mbarrier_arrive(
                direct_mcast_ready_mbar,
                peer_cta_rank_in_cluster=Int32(1) - rank,
            )
        _mbarrier_wait_acquire_cluster(
            direct_mcast_ready_mbar,
            Int32(0),
