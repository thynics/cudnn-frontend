...
| A24 | 2026-08-14 | A20 isolates the harmful overlap to rank-1 slot 0 while slot 1 remains throughput-positive. Deferring only slot 0's second half may retain all accumulation but remove part of its critical-window MIO pressure. | Preserve all 16 REDG and all four N=4 pacing barriers: issue slot 0 ops 0-3, consume/release and issue all eight slot 1 ops, then resume slot 0 ops 4-7. No address, writer, rank, credit, or 2-CTA work changes. | pending | pending; expected 1-2.5% | — | Static barrier/credit audit and B200 compile/perf gate first; reject before correctness/trace if below +2%. |
