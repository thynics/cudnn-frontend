...
| A22 | 2026-08-14 | Atomic-on vs no-atomic SMART shows rank-1 W39 round commits become 68-115 ns more skewed at G5/G7 while W37 transport issue skew barely changes. If reducer MIO issue starves the commit relay's scheduler, moving that low-register role should shorten the slot-0 overlap without removing work. | Rank 1 only: swapped logical roles of idle follower-MMA W16 and commit-relay W19. Both remained in physical WG4 at 64 registers; all work and synchronization counts were unchanged. | M0 8.914544 ms; A22 8.899504 ms / 617.738 TFLOPS | +0.183% | REJECTED | Same-B200 ABBA 4-pair gate, revision `4422b4d`, ratio 0.998171. Safe but far below the +2% bar; no repeat, correctness, NCU, IKET, or SMART. Artifact `.dsa-allinone/a22-4422b4d/run-r0/safety-result/perf.json`; source restored to M0. |
| A23 | 2026-08-14 | W17 owns every rank-1 round/TMA launch and currently shares SMSP1 with reducer W9/W13. Moving this low-register producer to idle W16 tests whether REDG MIO issue delays transport/completion before W19 observes it. | Rank 1 only: swapped logical roles of idle follower-MMA W16 and load/round producer W17, including descriptor prefetch and role dispatch. Both stayed in physical WG4 at 64 registers; all producer commits, barriers, REDG/T2R, addresses, and 2-CTA MMA were unchanged. | M0 8.913360 ms; A23 8.902464 ms / 617.532 TFLOPS | +0.131% | REJECTED | Same-B200 ABBA 4-pair gate, revision `c262d7a`. Safe but far below the +2% bar; no repeat, correctness, NCU, IKET, or SMART. Artifact `.dsa-allinone/a23-c262d7a/run-r0/safety-result/perf.json`; source restored to M0. |
| A24 | 2026-08-14 | A20 isolates the harmful overlap to rank-1 slot 0 while slot 1 remains throughput-positive. Deferring only slot 0's second half may retain all accumulation but remove part of its critical-window MIO pressure. | Preserved all 16 REDG and all four N=4 pacing barriers: issued slot 0 ops 0-3, consumed/released and issued all eight slot 1 ops, then resumed slot 0 ops 4-7. No address, writer, rank, credit, or 2-CTA work changed. | M0 8.915184 ms; A24 9.454336 ms / 581.485 TFLOPS | -6.020% | REJECTED | Revision `4cba4a6`. Exact M0/A24 compile gates were identical at REG96/STACK16 and 17 REDG/48 LDL/21 STL, so the regression is schedule wait exposure rather than new static spill. Slot 1 is not ready at slot 0's midpoint; forcing its wait removes useful slot-0 latency hiding. Artifact `.dsa-allinone/a24-4cba4a6/run-r0/safety-result/perf.json`; source restored to M0. |
