...
| A23 | 2026-08-14 | W17 owns every rank-1 round/TMA launch and currently shares SMSP1 with reducer W9/W13. Moving this low-register producer to idle W16 tests whether REDG MIO issue delays transport/completion before W19 observes it. | Rank 1 only: swap logical roles of idle follower-MMA W16 and load/round producer W17, including descriptor prefetch and role dispatch. Both stay in physical WG4 at 64 registers; all producer commits, barriers, REDG/T2R, addresses, and 2-CTA MMA remain unchanged. | pending | pending; expected 0.5-2% | — | Independent static validation then same-B200 4-pair gate; no new trace first. |
