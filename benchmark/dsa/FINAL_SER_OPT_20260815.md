...
| H12 | Raise only the four math warps from `setmaxregister_increase(136)` to 144, consuming the final 1,024-register CTA launch-allocation slack. | Retain the remaining dS-side loop state after H11 removed P's rank dependency. Require no-cache role-level spill comparison and a TopK=128 canary before any long-shape run. | rejected | REG=96/STACK=8 is unchanged, but local traffic worsens from H11's 36 to 38 instructions (`LDL 20 -> 22`, `STL=16`). The steady dS reload remains and the extra loads appear around the one-time dQ epilogue. TopK=128 is 1.235056 ms H11 versus 1.237840 ms H12: H12/H11 1.002423, halves 1.002630/1.002423, CI [1.001697, 1.002955], with exact-shape crosscheck PASS. Reverted to H11 without a TopK=2048 run. |
...
- H10 deferred-S-retirement artifacts:
  `outputs/final_ser_kq6q_h10_s_retire_20260815/`.  The no-cache spill
  product SHA256 is
  `e7cc125d9f7ea78dd652f37ef8dca31943d2280a4a986ab46de50450e852b2e1`,
  the TopK=128 canary SHA256 is
...
- H12 math-144 artifacts:
  `outputs/final_ser_kq6q_h12_math144_20260815/`. The no-cache spill product
  SHA256 is
  `d15bf1506a4557682fbe8d6c54386999d7709e112c7ad56bef2f63bce0c06d87`,
  and the TopK=128 canary SHA256 is
  `f584f13b95b7965f0acea503d8ab1bb45b7113b280e60a816f41c04ce251c199`.
