    ...
    def kernel(
        ...
        if warp_idx < Int32(self.GATHER_WARPS):
            ...
            for loop_iter in cutlass.range(tile_count):
                ...
                # e11: the pds credit wait (leader's release of the
                # previous tile's P/dS consumption) has no dependency on
                # the softmax below -- acquire before computing so the
                # spin overlaps the exp2 loop instead of sitting between
                # softmax and the stores.
