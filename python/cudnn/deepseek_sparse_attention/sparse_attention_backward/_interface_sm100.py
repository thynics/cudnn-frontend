...
def _select_sm100_backend(
    ...
    *,
    ...
    only for SM100 (10, 0) and the SM103 ablation target (10, 3) within the
    BF16 H128/D512 envelope; every other supported configuration retains the
    established backend.
    """
    if (
        device_capability in ((10, 0), (10, 3))
