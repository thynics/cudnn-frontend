"""IKET-only derivative of final_ser_kq6n.

final_ser_kq6n = final_ser_kq6f(r1) + B-plan true-K32 four-slot ring only
...
_LEAN_SPANS = (
    ...
    "dQ_ISSUE(",
    "WAIT_RELAY(",
    # kq6n-lean: leader fine-grained waits dropped -- 16 ring spans/tile
...
def _nanosleep_u32(
    ...
    *,
    ...
    """Warp nanosleep hint (sm70+).  kq6n: paces the reducer atomic
...
class FlashAttentionDSABackwardSm100TwoCTA(FlashAttentionDSABackwardSm100):
    ...
    TMEM_COLUMNS = 512
    # kq6n: inter-chunk pacing (ns) for the reducer atomic bursts.
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    # kq6n B plan: four independent K32 slots publish each old K64 panel
    ...
    def kernel(
        ...
        # kq6n compile-time release gates.  Fragments are built directly
    ...
    def _issue_grads_kq_v1(
        ...
        """kq same-tile gradient chain: dV r0/r1 -> dK r0/r1 -> dQ (kq6n swap).
        ...
        # (kq6n) dK moved BEFORE dQ: relay 1 relies on dV's long
        # ring window for DSM cover.
        relay_wait_token = _iket.range_start(
            "WAIT_RELAY(i,p)",
            issue_seq * Int32(2) + Int32(1),
        )
        ...
        # (kq6n) dQ moved AFTER dK: both rounds off the kscore kdq generation (both K_dQ
    ...
    def _drain_dkv_v8(
        ...
        for i in cutlass.range_constexpr(8):
            ...
            # kq6n: pace the burst (concentration knife).
