"""v_f1_1: vk_2 + relay commit-first (R2 -- the pds gate sheds the routing).
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    * The gradient GEMMs of tile p are issued inside tile t=p-1's S/dP
    ...
    def _issue_prev_grads_head_v2(
        ...
        # published: invariant I1's only gate.  (v_f1_1: the commit no
        # longer implies the DSM sends were issued; landed-data consumers
        # keep their own relay/landing gates.)
