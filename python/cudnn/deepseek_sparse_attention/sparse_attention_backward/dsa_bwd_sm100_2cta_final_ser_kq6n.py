"""DeepSeek Sparse Attention backward, two-CTA SERIAL chain, kq6n.
...
final_ser_kq6n = final_ser_kq6c + REDG BURST PACING only (single
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    def _issue_grads_kq_v1(
        ...
        # (kq6n) dK moved BEFORE dQ: relay 1 relies on dV's long ring
        # window for DSM cover; frees ring Q slots earlier and starts
        # the reducer earlier (rain shifts onto immune dQ MMA).
        _mbarrier_wait_acquire_cluster(
            relay_mbars + 1,
            relay_phase,
        )
