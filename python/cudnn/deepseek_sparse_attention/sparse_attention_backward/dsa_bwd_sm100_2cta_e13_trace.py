        ...
        if warp_idx < Int32(self.GATHER_WARPS):
            ...
            if tidx % Int32(32) == Int32(0):
                ...
                for loop_iter in cutlass.range(tile_count):
                    ...
                    # dS-early split gate (lite): pds_ready already
                    # proves this CTA's whole-image dS store, so commit
                    # the leader's dQ gate now -- ahead of the DSM push
                    # issues and the full pds commit.
