"""IKET-only derivative of final_ser_kq6s0.

final_ser_kq6s0 = final_ser_kq6f(r1) + B-plan true-K32 four-slot ring only
...
_LEAN_SPANS = (
    ...
    "dQ_ISSUE(",
    "WAIT_RELAY(",
    # kq6s0-lean: leader fine-grained waits dropped -- 16 ring spans/tile
...
def _nanosleep_u32(
    ...
    *,
    ...
    """Warp nanosleep hint (sm70+).  kq6s0: paces the reducer atomic
...
class FlashAttentionDSABackwardSm100TwoCTA(FlashAttentionDSABackwardSm100):
    ...
    TMEM_COLUMNS = 512
    # kq6s0: inter-chunk pacing (ns) for the reducer atomic bursts.
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    # kq6s0 B plan: four independent K32 slots publish each old K64 panel
    ...
    def kernel(
        ...
        # kq6s0 compile-time release gates.  Fragments are built directly
        ...
        if warp_idx < Int32(self.GATHER_WARPS):
            ...
            # kq6s0: warp 18 is the DEDICATED P relay -- the dS leg
            # lives on warp DS_RELAY_WARP.  No divergence, no cross-tile
            # queuing: this warp is always parked on the next p_ready.
            ...
            # kq6s0: dedicated dS relay warp (split off warp 18).
            ds_lane = tidx % Int32(32)
            if ds_lane == Int32(0):
    ...
    def _drain_dkv_v8(
        ...
        for i in cutlass.range_constexpr(8):
            ...
            # kq6s0: pace the burst (concentration knife).
