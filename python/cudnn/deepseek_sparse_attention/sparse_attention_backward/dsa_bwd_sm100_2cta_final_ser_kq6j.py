"""DeepSeek Sparse Attention backward, two-CTA SERIAL chain, kq6j.

final_ser_kq6j = final_ser_kq6f(r1) + L2 prefetch for exposed
ring generations G2/G3 (C.3), single variable.

Below: the final_ser_kq6f(r1) build docstring.

final_ser_kq6f = final_ser_kq6c + REDG BURST PACING only (single
