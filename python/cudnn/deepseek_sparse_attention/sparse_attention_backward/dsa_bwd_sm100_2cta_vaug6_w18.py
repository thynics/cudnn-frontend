...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    then tile t-1's eight dV/dK passes, while W18 issues dQ(t) after its
    P/dS relay completes. The kdq rendezvous hands the gather-filled dQ-A
    ...
    def kernel(
        ...
        if warp_idx < Int32(self.GATHER_WARPS):
            ...
            for loop_iter in cutlass.range(tile_count):
                ...
                # The warp reconverges after lane 0 publishes both relay
                # completions. Only the leader CTA issues the CG2 dQ MMAs.
                cute.arch.sync_warp()
                if is_leader_cta:
