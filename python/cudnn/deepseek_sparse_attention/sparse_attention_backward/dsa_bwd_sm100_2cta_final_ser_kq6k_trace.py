"""IKET-only derivative of final_ser_kq6k.

final_ser_kq6k = final_ser_kq6f(r1) + B-plan true-K32 four-slot ring only
...
def _nanosleep_u32(
    ...
    *,
    ...
    """Warp nanosleep hint (sm70+).  kq6k: paces the reducer atomic
...
class FlashAttentionDSABackwardSm100TwoCTA(FlashAttentionDSABackwardSm100):
    ...
    TMEM_COLUMNS = 512
    # kq6k: inter-chunk pacing (ns) for the reducer atomic bursts.
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    def _drain_dkv_v8(
        ...
        for i in cutlass.range_constexpr(8):
            ...
            # kq6k: pace the burst (concentration knife).
