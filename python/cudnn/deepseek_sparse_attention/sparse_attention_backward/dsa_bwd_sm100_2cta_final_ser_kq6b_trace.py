"""IKET-only derivative (kq6b: deferred s/dp releases; T2R spans no longer contain the release arrive -- expect T2R_S/T2R_dP to shrink ~0.03-0.1 vs kq6a twin).
    ...
    def kernel(
        ...
        if warp_idx < Int32(self.GATHER_WARPS):
            ...
            for loop_iter in cutlass.range(tile_count):
                ...
                cute.arch.fence_view_async_tmem_load()
                # kq6b: S-slot release deferred past the P close.
                ...
                # kq6b: deferred S-slot release (post-close slack).
                ...
                cute.arch.fence_view_async_tmem_load()
                # kq6b: dP-slot release deferred past the dS close.
                ...
                # kq6b: deferred dP-slot release (post-close slack).
