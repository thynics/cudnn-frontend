...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    def _drain_dkv_v8(
        ...
        transition (the tile's final-dK completion), then emits both atomic
        bursts back-to-back.  Split wait/release pipeline states still let
        both releases trail their own fences (round_acq/round_com pattern).
        """
        ...
        # the tile has completed.  Issue R0 and R1 back-to-back from here.
