...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    def kernel(
        ...
        # Budget-neutral W19 pressure ablation: reducers donate 8 registers
        # each (120 -> 112), funding 16 more for each control warp
        # (64 -> 80). The weighted CTA total stays at 61,440 registers, so
        # occupancy and the W19 overlap schedule are unchanged.
