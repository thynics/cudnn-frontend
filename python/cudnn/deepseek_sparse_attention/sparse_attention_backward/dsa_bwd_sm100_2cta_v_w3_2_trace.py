"""v_w3_2_trace: v_w3_2 with the refined supply-wait spans (partial rebase).

Span delta rebased from vk_7_trace (26/37 hunks; the 11 skipped are the
gather-side RK_ACQ insertions whose anchors changed under R2/W3 -- gather
is not the pacer, so the leader/W17-side spans (PDS_WAIT, GRAD_SUP_WAIT,
MAT_ACQ, MAT_WAIT) carry the mining value).  Instrumentation-only.
"""
