"""IKET-only derivative of final_ser_kq6m.

final_ser_kq6m = final_ser_kq6f(r1) + B-plan true-K32 four-slot ring only
...
_LEAN_SPANS = (
    ...
    "dQ_ISSUE(",
    "WAIT_RELAY(",
    # kq6m-lean: leader fine-grained waits dropped -- 16 ring spans/tile
...
def _nanosleep_u32(
    ...
    *,
    ...
    """Warp nanosleep hint (sm70+).  kq6m: paces the reducer atomic
...
class FlashAttentionDSABackwardSm100TwoCTA(FlashAttentionDSABackwardSm100):
    ...
    TMEM_COLUMNS = 512
    # kq6m: inter-chunk pacing (ns) for the reducer atomic bursts.
...
class FlashAttentionDSABackwardSm100TwoCTAV2(
    ...
    # kq6m B plan: four independent K32 slots publish each old K64 panel
    ...
    def kernel(
        ...
        # kq6m compile-time release gates.  Fragments are built directly
    ...
    def _drain_dkv_v8(
        ...
        for i in cutlass.range_constexpr(8):
            ...
            # kq6m: pace the burst (concentration knife).
