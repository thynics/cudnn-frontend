...
- **Sparse Attention Backward**: DSA backward for flat MQA tensors on SM90/SM100, with dedicated Rubin SM107 kernels for contiguous BF16 H128 D512/V512 and D576/V512; consumes the forward wrapper's `out` and KV-only `lse`.
